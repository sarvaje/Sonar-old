...
const rule: IRuleBuilder = {
    create(context: RuleContext): IRule {
        ...
        const getXUACompatibleMetaTags = (elements: IAsyncHTMLElement[]): IAsyncHTMLElement[] => {
        ...
        const checkMetaTag = async (resource: string) => {
            ...
            const XUACompatibleMetaTags: IAsyncHTMLElement[] = getXUACompatibleMetaTags(await pageDOM.querySelectorAll('meta'));
            ...
            const bodyMetaTags: IAsyncHTMLElement[] = getXUACompatibleMetaTags(await pageDOM.querySelectorAll('body meta'));
