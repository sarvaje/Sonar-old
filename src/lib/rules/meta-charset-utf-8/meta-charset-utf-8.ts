...
const rule: IRuleBuilder = {
    create(context: RuleContext): IRule {
        ...
        const getCharsetMetaTags = (elements: IAsyncHTMLElement[]): IAsyncHTMLElement[] => {
        ...
        const validate = async (event: ITraverseEnd) => {
            ...
            const charsetMetaTags: IAsyncHTMLElement[] = getCharsetMetaTags(await pageDOM.querySelectorAll('meta'));
            ...
            const bodyMetaTags: IAsyncHTMLElement[] = getCharsetMetaTags(await pageDOM.querySelectorAll('body meta'));
